...
import { Dimensions, TextStyle, StyleProp, ImageStyle, StyleSheet, View, ViewStyle, FlatList, Animated, Button } from 'react-native'
...
export const FaceDetection: React.FC<FaceDetectionScreenProps> = (props) => {
    ...
    const onSuccess = (data?: FaceDetectionInfo) => {
...
const styles = StyleSheet.create({
    ...
    boxButton: { backgroundColor: '#fff', padding: 40, borderTopLeftRadius: 8, borderTopRightRadius: 8 },
    textButtonModal: {
        flexDirection: 'row',
        alignItems: 'center'
    },
